...
const processFile = async (filePath) => {
    ...
    try {
        ...
        console.log('completed data insertion to db ')
    
        parentPort.postMessage('Record inserted Successfully...!!')
    } catch (error) {
        console.log(error);
        parentPort.postMessage('Something went wrong in worker thread excecution')
    }
};
